...
//$$		return server.getLevelIdName();
	...
	public void savestate() throws SavestateException, IOException {
		...
		sendMessage(server, net.minecraft.network.chat.Component.literal(ChatFormatting.GREEN + "Savestate saved!")); //@TextComponent;
	}
	...
	public void loadstate() throws LoadstateException, IOException {
		...
		sendMessage(server, net.minecraft.network.chat.Component.literal(ChatFormatting.GREEN + "Savestate loaded")); //@TextComponent;
	}
...
//$$		server.getPlayerList().broadcastMessage(component, ChatType.CHAT, Util.NIL_UUID);
		//#def
//$$		server.getPlayerList().broadcastMessage(component);
		//#end
	}
	...
	public File getSavestateDirectory() {
